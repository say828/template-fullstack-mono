...
GUIDE_CONFIG = {
    "service": "dealer",
    "spec_pdf": ROOT / "sdd/01_planning/02_screen/ir/dealer/dealer_screen_spec.pdf",
    "spec_pdf_display": "sdd/01_planning/02_screen/ir/dealer/dealer_screen_spec.pdf",
    "dpi": 110,
    "analysis_max_width": 320,
    "page_start": 2,
    "page_end": 39,
    "output_json": GUIDE_OUTPUT_DIR / "dealer_screen_design_guide.json",
    "surface_detection": {
