...
GUIDE_CONFIG = {
    "service": "admin",
    "spec_pdf": ROOT / "sdd/01_planning/02_screen/ir/admin/admin_screen_spec.pdf",
    "spec_pdf_display": "sdd/01_planning/02_screen/ir/admin/admin_screen_spec.pdf",
    "dpi": 110,
    "analysis_max_width": 320,
    "page_start": 2,
    "page_end": 63,
    "output_json": GUIDE_OUTPUT_DIR / "admin_screen_design_guide.json",
    "surface_detection": {
